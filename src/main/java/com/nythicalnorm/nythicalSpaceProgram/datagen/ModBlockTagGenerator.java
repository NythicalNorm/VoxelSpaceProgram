...
public class ModBlockTagGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        this.tag(BlockTags.NEEDS_STONE_TOOL).add(ModBlocks.CRYOGENIC_AIR_SEPARATOR.get(), ModBlocks.MAGNETIZER.get(),
                ModBlocks.MAGNETIZED_IRON_BLOCK.get(), ModBlocks.CRYOGENIC_AIR_SEPARATOR_PART.get());
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(ModBlocks.CRYOGENIC_AIR_SEPARATOR_PART.get())
                .add(ModBlocks.MAGNETIZER.get())
                .add(ModBlocks.MAGNETIZED_IRON_BLOCK.get());
