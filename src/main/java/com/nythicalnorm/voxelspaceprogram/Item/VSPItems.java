...
public class VSPItems {
    ...
    public static final RegistryObject<Item> SPACESUIT_HELMET =  ITEMS.register("spacesuit_helmet", () ->
            new ArmorItem(VSPArmorMaterial.SPACESUIT, ArmorItem.Type.HELMET, new Item.Properties()));
    ...
    public static final RegistryObject<Item> SPACESUIT_LEGGINGS =  ITEMS.register("spacesuit_leggings", () ->
            new ArmorItem(VSPArmorMaterial.SPACESUIT, ArmorItem.Type.LEGGINGS, new Item.Properties()));

    public static final RegistryObject<Item> SPACESUIT_BOOTS =  ITEMS.register("spacesuit_boots", () ->
            new ArmorItem(VSPArmorMaterial.SPACESUIT, ArmorItem.Type.BOOTS, new Item.Properties()));
